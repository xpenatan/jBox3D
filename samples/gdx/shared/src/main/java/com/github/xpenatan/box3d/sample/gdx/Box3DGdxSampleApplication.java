...
public final class Box3DGdxSampleApplication extends ApplicationAdapter implements Box3DSampleHost {
    ...
    private final Box3DGdxSampleBackend backend;
    ...
    private void createSelector() {
        skin = createSkin();
        stage = backend.createStage(new ScreenViewport());
    ...
    private void applyDebugVisualization() {
        ...
        visualization.apply(debugRenderer.debugDraw());
    }
    ...
    private Skin createSkin() {
        Skin selectorSkin = backend.createSkin("data/uiskin.json");
    ...
    private Drawable addUiDrawable(Skin skin, String fileName, String name, float minWidth, float minHeight) {
        return backend.addUiDrawable(skin, fileName, name, minWidth, minHeight);
    }
