...
public final class Box3DGdxWgpuWebLauncher {
    private Box3DGdxWgpuWebLauncher() {
    }
    ...
    public static void main(String[] args) {
        ...
        ApplicationListener listener = new Box3DGdxSampleApplication(new GdxWgpuSampleBackend(), exitAfterFrames);
