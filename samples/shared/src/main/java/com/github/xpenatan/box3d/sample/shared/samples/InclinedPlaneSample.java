...
final class InclinedPlaneSample extends AbstractBox3DSample {
    InclinedPlaneSample() {
        ...
        for(int i = 0; i < 5; i++) {
            ...
            // The C sample deliberately reuses bodyDef, so the boxes inherit the ramp rotation.
            addDynamicBox(-10.0f + 5.0f * i, 14.25f, -10.6f, 1.0f, 1.0f, 1.0f, rampRotation, 1.0f,
                    friction, 0.0f, 0.0f);
        }
