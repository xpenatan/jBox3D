...
final class ManifoldCapsuleVsHullSample extends AbstractBox3DSample {
    ManifoldCapsuleVsHullSample() {
        DiagnosticUtil.addPairBase(this);
        addDynamicCapsule(-0.6f, 4.0f, 0.0f, 0.9f, 0.25f);
        addDynamicBox(0.4f, 4.2f, 0.0f, 0.75f, 0.75f, 0.75f);
    }
}
