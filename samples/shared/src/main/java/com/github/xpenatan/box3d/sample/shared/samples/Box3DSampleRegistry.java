...
public final class Box3DSampleRegistry {
    ...
    private static List<Box3DSampleEntry> createEntries() {
        ...
        entries.add(new Box3DSampleEntry("Stacking", "Box Stack", BoxStackSample::new,
                new Box3DSampleCamera(40.0f, 15.0f, 50.0f, 0.0f, 20.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Stacking", "Jenga Stack", JengaStackSample::new,
                new Box3DSampleCamera(35.0f, 15.0f, 12.0f, 0.0f, 2.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Stacking", "Wedge", WedgeSample::new,
                new Box3DSampleCamera(75.0f, 10.0f, 10.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Stacking", "Pyramid2D", Pyramid2DSample::new,
                new Box3DSampleCamera(40.0f, 15.0f, 50.0f, 0.0f, 12.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Stacking", "Edge Crossing", EdgeCrossingSample::new,
                new Box3DSampleCamera(0.0f, 25.0f, 10.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Shapes", "Conveyor Mesh", ConveyorMeshSample::new,
                new Box3DSampleCamera(65.0f, 25.0f, 28.0f, 0.0f, 1.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Bodies", "Spinning Book", SpinningBookSample::new,
                new Box3DSampleCamera(0.0f, 30.0f, 10.0f, 0.0f, 1.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Bodies", "Gyroscopic Torque", GyroscopicTorqueSample::new,
                new Box3DSampleCamera(0.0f, 20.0f, 4.0f, 0.0f, 2.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Bodies", "Gyroscopic Precession", GyroscopicPrecessionSample::new,
                new Box3DSampleCamera(40.0f, 30.0f, 75.0f, 0.0f, 2.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Bodies", "Weeble", WeebleSample::new,
                new Box3DSampleCamera(45.0f, 25.0f, 25.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Bodies", "Cast", BodyCastSample::new,
                new Box3DSampleCamera(120.0f, 30.0f, 20.0f, 0.0f, 1.5f, 0.0f)));
        entries.add(new Box3DSampleEntry("Bodies", "Kinematic", KinematicSample::new,
                new Box3DSampleCamera(0.0f, 30.0f, 10.0f, 0.0f, 1.5f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Bodies", "Fixed Rotation", FixedRotationSample::new,
                new Box3DSampleCamera(0.0f, 15.0f, 10.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Bodies", "Class Ring", ClassRingSample::new,
                new Box3DSampleCamera(40.0f, 30.0f, 15.0f, 0.0f, 2.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Compound", "Village", VillageSample::new,
                new Box3DSampleCamera(45.0f, 10.0f, 5.0f, 0.0f, 10.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Joints", "Distance Joint", DistanceJointSample::new,
                new Box3DSampleCamera(0.0f, 0.0f, 40.0f, 0.0f, 10.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Joints", "Motor Joint", MotorJointSample::new,
                new Box3DSampleCamera(0.0f, 0.0f, 25.0f, 0.0f, 8.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Joints", "Top Down Friction", TopDownFrictionSample::new,
                new Box3DSampleCamera(0.0f, 0.0f, 26.0f, 0.0f, 10.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Joints", "Wheel", WheelJointSample::new,
                new Box3DSampleCamera(25.0f, 20.0f, 7.0f, 0.0f, 2.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Joints", "Ball and Chain", BallAndChainSample::new,
                new Box3DSampleCamera(180.0f, 15.0f, 50.0f, 0.0f, -20.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Character", "Mover", CharacterMoverSample::new,
                new Box3DSampleCamera(120.0f, 30.0f, 5.0f, 7.5f, 0.75f, 9.0f)));
        entries.add(new Box3DSampleEntry("Character", "MoverOverlap", CharacterMoverOverlapSample::new,
                new Box3DSampleCamera(120.0f, 25.0f, 10.0f, 0.0f, 1.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Character", "Rigid Body", CharacterRigidBodySample::new,
                new Box3DSampleCamera(120.0f, 30.0f, 5.0f, 7.5f, 2.0f, 9.0f)));
        entries.add(new Box3DSampleEntry("Determinism", "Falling Ragdolls", DeterminismFallingRagdollsSample::new,
                new Box3DSampleCamera(45.0f, 30.0f, 40.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Determinism", "Wave Pile", DeterminismWavePileSample::new,
                new Box3DSampleCamera(45.0f, 25.0f, 25.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Determinism", "Query Spawn", DeterminismQuerySpawnSample::new,
                new Box3DSampleCamera(45.0f, 25.0f, 30.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Determinism", "Mesh Drop", DeterminismMeshDropSample::new,
                new Box3DSampleCamera(0.0f, 30.0f, 20.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Ragdoll", "Box", RagdollBoxSample::new,
                new Box3DSampleCamera(45.0f, 30.0f, 6.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Issues", "Multiple Prismatic", IssueMultiplePrismaticSample::new,
                new Box3DSampleCamera(0.0f, 0.0f, 25.0f, 0.0f, 5.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Issues", "s&box mover", IssueSandboxMoverSample::new,
                new Box3DSampleCamera(45.0f, 30.0f, 12.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Issues", "s&box Ghost Collisions", IssueSandboxGhostCollisionsSample::new,
                new Box3DSampleCamera(90.0f, 25.0f, 10.0f, 0.0f, 1.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Issues", "GMod Wheel Stack", IssueGmodWheelStackSample::new,
                new Box3DSampleCamera(0.0f, 12.0f, 5.0f, 0.0f, 0.85f, 0.0f)));
        entries.add(new Box3DSampleEntry("Issues", "Restitution Overshoot", IssueRestitutionOvershootSample::new,
                new Box3DSampleCamera(20.0f, 0.0f, 28.0f, 0.0f, 10.5f, 0.0f)));
        entries.add(new Box3DSampleEntry("Issues", "Slide Twist Off Center Shape", IssueSlideTwistOffCenterSample::new,
                new Box3DSampleCamera(-30.0f, 17.0f, 30.0f, 0.0f, 5.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Collision", "Cast World", CastWorldSample::new,
                new Box3DSampleCamera(45.0f, 30.0f, 20.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Collision", "Initial Overlap", InitialOverlapSample::new,
                new Box3DSampleCamera(-140.0f, 10.0f, 10.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Collision", "Long Ray Cast", LongRayCastSample::new,
                new Box3DSampleCamera(-35.0f, 22.0f, 34.0f, 0.0f, 1.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Collision", "Shape Distance", ShapeDistanceSample::new,
                new Box3DSampleCamera(-45.0f, 10.0f, 5.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Collision", "Time of Impact", TimeOfImpactSample::new,
                new Box3DSampleCamera(-90.0f, 0.0f, 10.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Manifold", "Triangle vs Hull", ManifoldTriangleVsHullSample::new,
                new Box3DSampleCamera(0.0f, 30.0f, 3.0f, 0.0f, 0.0f, 0.0f)));
        ...
        entries.add(new Box3DSampleEntry("Mesh", "Viewer", MeshViewerSample::new,
                new Box3DSampleCamera(45.0f, 30.0f, 50.0f, 0.0f, 0.0f, 0.0f)));
        entries.add(new Box3DSampleEntry("Mesh", "Voxel", MeshVoxelSample::new,
                new Box3DSampleCamera(-115.0f, 5.0f, 5.0f, 5000.0f, 3510.0f, -7000.0f)));
