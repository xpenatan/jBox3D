...
final class WeldJointSample extends AbstractBox3DSample {
    WeldJointSample() {
        addGroundBox(20.0f);
        ...
        jointDef.SetLinearHertz(0.0f);
        jointDef.SetLinearDampingRatio(0.0f);
        jointDef.SetAngularHertz(2.0f);
        jointDef.SetAngularDampingRatio(0.7f);
    ...
    private void setLocalPositionB(B3WeldJointDef jointDef, float x, float y, float z) {
        B3Vec3 position = new B3Vec3(x, y, z);
