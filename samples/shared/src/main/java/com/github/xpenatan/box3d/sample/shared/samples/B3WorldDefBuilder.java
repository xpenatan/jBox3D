...
final class B3WorldDefBuilder {
    private B3WorldDefBuilder() {
    }

    static void disableGravity(com.github.xpenatan.box3d.B3World world) {
        B3Vec3 gravity = new B3Vec3(0.0f, 0.0f, 0.0f);
        world.SetGravity(gravity);
        AbstractBox3DSample.dispose(gravity);
    }
}
