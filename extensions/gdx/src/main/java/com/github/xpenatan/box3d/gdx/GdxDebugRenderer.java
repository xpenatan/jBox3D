...
public class GdxDebugRenderer extends B3DebugDrawEm {
    ...
    public GdxDebugRenderer(ModelBatch modelBatch) {
        this(modelBatch, null, new ShapeRenderer(), false, true);
    }

    public GdxDebugRenderer(ShapeRenderer lineRenderer) {
        this(new ShadowBiasShaderProvider(), lineRenderer, true, false);
    }

    public GdxDebugRenderer(ModelBatch modelBatch, ShapeRenderer lineRenderer) {
        this(modelBatch, null, lineRenderer, false, false);
    }

    private GdxDebugRenderer(ShadowBiasShaderProvider modelShaderProvider, ShapeRenderer lineRenderer,
    ...
    private GdxDebugRenderer(ModelBatch modelBatch, ShadowBiasShaderProvider modelShaderProvider,
