        ...
        publications.configureEach {
            if (this is MavenPublication) {
                pom {
                    ...
                    scm {
                        connection.set("scm:git@github.com:xpenatan/jBox3D.git")
                        developerConnection.set("scm:git@github.com:xpenatan/jBox3D.git")
                        url.set("http://github.com/xpenatan/jBox3D")
                    }
                    licenses {
                        license {
